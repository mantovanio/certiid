...
-- Migration: 20260617_atendimento_inbox_backfill_chatwoot
-- Objetivo:
--   Reconstituir conversas e mensagens já existentes no Chatwoot
--   dentro do ledger nativo do CRM CertiID.
-- ================================================================
